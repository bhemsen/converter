...
def run_conversion_script(input_path, output_path):
    # Call the conversion script with input and output paths as arguments
    subprocess.run(["python", "mkv_to_mp4.py", input_path, output_path])
...
if __name__ == "__main__":
    ...
    for pair in input_output_pairs:
        ...
        run_conversion_script(pair[0], pair[1])
